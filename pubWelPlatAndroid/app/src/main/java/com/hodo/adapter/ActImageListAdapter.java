...
public class ActImageListAdapter extends ArrayAdapter<Act> {
     ...
     */
    public ActImageListAdapter(Context context, int resource, List<Act> objects) {
...
//        loadImg(imageView,url);
        ...
        TextView status = (TextView)view.findViewById(R.id.status); //从裁剪好的布局里获取TextView布局Id
        status.setText(imageListArray.getStatus());//将当前一组imageListArray类中的TextView内容导入到TextView布局中
