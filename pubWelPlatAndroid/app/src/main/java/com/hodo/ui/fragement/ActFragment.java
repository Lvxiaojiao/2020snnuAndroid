...
public class ActFragment extends BaseFragment  {
    ...
    public static ActFragment getInstance(String title) {
        ActFragment sf = new ActFragment();
        sf.mTitle = title;
        return sf;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab_act, null);
    ...
    protected void lazyLoadData() {
        ...
        rp.put("userGroup",userGroup);
        rp.put("key",key);
        rp.put("crealname",crealname);
        AsyncUtil.post("/act/actListA", rp, new AsyncHttpResponseHandler() {
            @Override
