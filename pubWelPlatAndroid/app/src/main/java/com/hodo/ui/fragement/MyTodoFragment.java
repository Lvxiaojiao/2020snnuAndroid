...
public class MyTodoFragment extends BaseFragment  {
    ...
    public static MyTodoFragment getInstance(String title) {
        MyTodoFragment sf = new MyTodoFragment();
        sf.mTitle = title;
        return sf;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.tab_mytodo_act, null);
    ...
    protected void lazyLoadData() {
        ...
        AsyncUtil.post("/act/myTodoActListA", rp, new AsyncHttpResponseHandler() {
            @Override
