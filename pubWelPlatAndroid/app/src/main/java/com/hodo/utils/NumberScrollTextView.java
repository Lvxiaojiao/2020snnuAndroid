...
public class NumberScrollTextView extends TextView implements IRiseNumber {
    ...
    private RiseNumberTextView.EndListener mEndListener = null;
...
//        }
        int courseMin=1;
        int courseMax=8;
        Random courseRand = new Random();
        int courseRandNumber = courseRand.nextInt(courseMax - courseMin + 1) + courseMin;
        return  courseRandNumber;
    }
